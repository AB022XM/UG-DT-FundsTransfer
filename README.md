...
To build the final jar and optimize the FundsTransferAPIGeneric application for production, run:
...
Then navigate to [http://localhost:8903](http://localhost:8903) in your browser.
