package ug.co.absa.transfer.web.rest;
...
import ug.co.absa.transfer.config.KafkaSseConsumer;
import ug.co.absa.transfer.config.KafkaSseProducer;

@RestController
@RequestMapping("/api/funds-transfer-api-generic-kafka")
public class FundsTransferApiGenericKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FundsTransferApiGenericKafkaResource.class);
    ...
    public FundsTransferApiGenericKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
